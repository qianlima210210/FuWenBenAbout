 ...
 *  CGFloat result;
 *  CGFloat arg1, arg2;
 *  [self qdim_performSelector:xxx withReturnValue:&result arguments:&arg1, &arg2, nil];
 ...
 */
- (void)qdim_enumrateInstanceMethodsUsingBlock:(void (^)(SEL selector))block;
 ...
 */
+ (void)qdim_enumerateProtocolMethods:(Protocol *)protocol usingBlock:(void (^)(SEL selector))block;
